...
var start_tomato_frame_offset: int = 6  # tomato row starts at frame 6
...
func _process(_delta: float) -> void:
	...
	# Tomato spritesheet frames:
	# 6..11 => Seed..Harvesting
	sprite_2d.frame = start_tomato_frame_offset + int(growth_state)
...
func on_crop_harvesting() -> void:
	...
	var harvest := tomato_harvest_scene.instantiate() as Node2D
